...
public class CoqParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Coq");
  ...
  { 
    CoqParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CoqParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CoqParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CoqParseControllerGenerated.class);
    }
  ...
  { 
    return CoqParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
